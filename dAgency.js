...
var setdAgency = function (businessObject) {
  ...
  // console.log(businessObject);
    ...
    else 
    {
		...
		{
        	D01.D01_06 = setD2("dAgency.10", _val[i]);
	        _valArray.push(_val[i]);
    	   _retArray.push("<dAgency.10>" + val[i] + "</dAgency.10>");
		}
        dAgency334["dAgency.10"] = _valArray;
    ...
    if (_val == null) {
        ...
        dAgency334["dAgency.11"] = _val[0];
        _retArray.push("<dAgency.11>" + val[0] + "</dAgency.11>");

    };

    _val = getValue(businessObject.elements, "dAgency.12");
    if (_val == null) {
        ErrorList.unshift("dAgency.12 MANDATORY Element");
    ...
    if (_val == null) {
        ErrorList.unshift("dAgency.13 MANDATORY Element");
    ...
    if (_val == null) {
        ErrorList.unshift("dAgency.14  MANDATORY Element");
    }
    else {
    ...
    if (_val == null) {
        ...
        v2ErrorList.unshift("D01.D01_19  MANDATORY Element");
    }
    else
    {
        dAgency334["dAgency.23"] = _val[0];
        D01.D01_19 = _val[0];   
        _retArray.push("<dAgency.23>" + val[0] + "</dAgency.23>");

    };
    _val = getValue(businessObject.elements, "dAgency.24");
    if (_val == null) {
        dAgency334["dAgency.24"] = null;
        v2ErrorList.unshift("D01.D01_20 MANDATORY Element");
    }
    else 
    {
        dAgency334["dAgency.24"] = _val[0];
        D01.D01_20 = _val[0];
        _retArray.push("<dAgency.24>" + val[0] + "</dAgency.24>");
    };
    ...
    else
    {
        ...
        for (var i = 0; i < businessObject.length ; i++)
		{
        	_v2valArray= setD2("dAgency.25", _val[i]);
	        _valArray.push(_val[i]);
    	   _retArray.push("<dAgency.25>" + val[i] + "</dAgency.25>");
		}
        dAgency334["dAgency.25"] = _val;
        D01.D01_21 = _v2valArray;
    ...
    if (_val == null) {
		...
		{
            _valArray.push(_val[i]);
    	   _retArray.push("<dAgency.26>" + val[i] + "</dAgency.26>");
		}
        dAgency334["dAgency.26"] = _valArray;
    };    
...
var setAgencyServiceGroup = function (groupObject) {
    ...
    for (var x = 0; x < groupObject.length ; x++)
    {        
        _val = (groupObject[x].elements, "dAgency.05");
        if (_val == null)
        {
        ...
        else
        {
            ...
            _retArray.push("<dAgency.05>" + val[0] + "</dAgency.05>");

        };

        _val = getValue(groupObject[x].elements, "dAgency.06");
        if (_val == null)
        {
        ...
        for (var i = 0; i < businessObject.length ; i++)
		{
        	_v2valArray.push(setD2("dAgency.06", _val[i]));
	        _valArray.push(_val[i]);
    	   _retArray.push("<dAgency.06>" + val[i] + "</dAgency.06>");
		}
        dAgency334["dAgency.06"] = _valArray;
        D01.D01_04 = _v2valArray;
        };
		...
		{
	        _valArray.push(_val[i]);
    	   _retArray.push("<dAgency.07>" + val[i] + "</dAgency.07>");
		}
        dAgency334["dAgency.07"] = _valArray;
        ...
        else
        {
			...
			{
	    	    _valArray.push(_val[i]);
    		   _retArray.push("<dAgency.08>" + val[i] + "</dAgency.08>");
			}
        	dAgency334["dAgency.08"] = _valArray;
        };
//        console.log(AgencyServiceGroup);
...
var setAgencyYearGroup = function (groupObject) {
    ...
    for (var i = 0; i < groupObject.length ; i++) {
        ...
        if (_val == null) {
            ...
            v2ErrorList.push("dAgency.17 required");
        ...
        if (_val == null) {
            ...
            v2ErrorList.push("dAgency.18 required");
        ...
        if (_val == null) {
            ...
            v2ErrorList.push("dAgency.19 required");
        ...
        if (_val == null) {
            ...
            v2ErrorList.push("dAgency.20 required");
        ...
        if (_val == null) {
            ...
            AgencyYearGroup["dAgency.21"] = v3NOT_RECORDED;
           	v2ErrorList.push("dAgency.21 required");
        ...
        if (_val == null) {
            if (isRequiredStateElement("dAgency.22") == true) {
                ...
                AgencyYearGroup["dAgency.22"] = v3NOT_RECORDED;
               	v2ErrorList.push("dAgency.22 required");
